...
public class HomeWork5 {
    ...
    public static class Person {
        ...
        private static int protection = 0;
        private static int health = 50;

        static String announce() {
            return "Person " + Person.getName() + " имеет характеристики: " + Person.getHealth() + " здоровья и " + Person.getProtection() + " защиты";
        }
        static void takeDamage(Integer damage) throws Exception {if (damage >= 0)
        {if (health - (damage - Person.getProtection()) < 0) {health = 0;
            throw new PersonDead("");}
            else health = health - (damage - Person.getProtection());}
        else throw new Exception();}
        Integer facePunch() throws Exception {takeDamage(0); return 1;}
    }
    ...
    public static class Mage extends Person{
        ...
        private static String name;
        private static int protection = 15;
        ...
        static String announce() {Person.protection = protection;
            Person.health = health;
            return "Mage " + Person.announce();}
        static void takeDamage(Integer damage) throws Exception {if (damage >= 0)
        {if (health - (damage - Mage.getProtection() - health % 10) < 0) {health = 0;
            throw new PersonDead("");}
        else health = health - (damage - Mage.getProtection() - health % 10);}
        else throw new Exception();}
        Integer fireBall() throws Exception {Person.takeDamage(0); return 45;}
    }
    ...
    public static class Archer extends Person{
        ...
        private static String name;
        private static int protection = 12;
        ...
        static String announce() {Person.protection = protection;
            Person.health = health;
            return "Archer " + Person.announce();}
        static void takeDamage(Integer damage) throws Exception {if (damage >= 0)
        {if (health - (damage - Archer.getProtection() + health % 10) < 0) {health = 0;
            throw new PersonDead("");}
        else health = health - (damage - Archer.getProtection() + health % 10);}
        else throw new Exception();}
        Integer shootBow() throws Exception {Person.takeDamage(0); return 40 + health % 10;}
    }
